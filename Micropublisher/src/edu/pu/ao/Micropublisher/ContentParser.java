 ...
 *     <messageid> MESSAGE_ID_HERE </messageid> // messageid = uuid + system time
 * </content>
 * 
...
public class ContentParser {
	...
	public static String createFile(String message, String uuid, String signature, String messageId) {
		String filepath = null;
		
		Log.d(Micropublisher.LOG_TAG, "creating XML file. msg: " + message);
		try {
			// create document
			...
			rootElement.appendChild(messageIdElement);
			messageIdElement.appendChild(document.createTextNode(messageId));
